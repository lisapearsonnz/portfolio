...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[var(--primary-color)] text-[var(--text-accent)]'>
    <div>
        <a href = '/'></a><img src={Logo} alt ='Lisa Pearson Logo' style = {{width: '50px'}} />
    </div>

{/*Menu */}
    <ul className ='hidden md:flex [var(--text-primary)]'>
...
{/*Mobile Menu*/}
    <ul className={!nav ? 'hidden' : ' absolute top-0 left-0 w-full h-screen bg-[var(--primary-color)] flex flex-col justify-center items-center'} >
        <li className = 'py-6 text-4xl'><Link onClick={handleClick} activeClass="active" to="home" smooth={true} duration={500}>
          Home
        </Link></li>
        <li className = 'py-6 text-4xl'><Link onClick={handleClick} activeClass="active" to="about" smooth={true} offset={-75} duration={500}>
          About
        </Link></li>
        <li className = 'py-6 text-4xl'><Link onClick={handleClick} activeClass="active" to="skills" smooth={true} offset={-75} duration={500}>
          Skills
        </Link></li>
        <li className = 'py-6 text-4xl'><Link onClick={handleClick} activeClass="active" to="works" smooth={true} offset={-75} duration={500}>
          Works
        </Link></li>
        <li className = 'py-6 text-4xl'><Link onClick={handleClick} activeClass="active" to="contact" smooth={true} offset={-75} duration={500}>
          Contact
        </Link></li>
    </ul>
...
<ul>
    <li className = 'w-[160px] h-[60px] flex justify-between items-center ml-[-100px] duration-300 hover:ml-[-10px] bg-[var(--secondary-color)]'>
